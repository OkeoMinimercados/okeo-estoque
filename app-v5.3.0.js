...
const FRONTEND_VERSION="5.3.0";
const EXPECTED_BACKEND_VERSION="5.3.0";
...
function jsonpRpcRequest(action,params={},timeoutMs=15000){
  ...
  return new Promise((resolve,reject)=>{
    ...
    script.async=true;
    script.onerror=()=>finish(reject,new Error("FALHA_REDE_BASE_CENTRAL"));
...
async function runDeepHealthCheck(){
  ...
  if(remote.ok){
    ...
    add("Backend",status.version==="5.3.0",`publicado v${status.version||"?"} • esperado v5.3.0`);
