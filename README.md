...
Versão final corrigida após revisão ponta a ponta da V3.71.

## Correções principais
- Reposição operacional volta a abrir corretamente dentro de Compras.
- Histórico de reposições de homologação é limpo uma única vez na migração V3.71 (perfil Administrador).
...
- Mantidas as correções V3.71 de Produto × Condomínio, planogramas oficiais, desempenho e cache.
- Service Worker usa cache exclusivo `okeo-core-v3-46-final`.

## Publicação
Publique todo o conteúdo do pacote GitHub, inclusive `seed-planograms-v3.71.json`, e publique o Apps Script V3.71. Depois, atualize forçadamente o navegador/PWA para substituir o cache anterior.


## V3.71 — correção crítica de Gestão de Estoque
...
- Na V3.71 os dois últimos painéis estavam aninhados dentro de Controle Geral e eram ocultados junto com ele.
