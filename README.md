...
Versão final corrigida após revisão ponta a ponta da V3.74.

## Correções principais
- Reposição operacional volta a abrir corretamente dentro de Compras.
- Histórico de reposições de homologação é limpo uma única vez na migração V3.74 (perfil Administrador).
...
- Mantidas as correções V3.74 de Produto × Condomínio, planogramas oficiais, desempenho e cache.
- Service Worker usa cache exclusivo `okeo-core-v3-46-final`.

## Publicação
Publique todo o conteúdo do pacote GitHub, inclusive `seed-planograms-v3.74.json`, e publique o Apps Script V3.74. Depois, atualize forçadamente o navegador/PWA para substituir o cache anterior.


## V3.74 — correção crítica de Gestão de Estoque
...
- Na V3.74 os dois últimos painéis estavam aninhados dentro de Controle Geral e eram ocultados junto com ele.
